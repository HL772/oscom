...
//   openat("/fatlog.txt") + write -> 覆盖 FAT32 文件写入路径
...
const USER_CODE: [u8; 924] = [
    ...
    0x73, 0x00, 0x00, 0x00, 0x63, 0x42, 0x05, 0x04, 0x13, 0x04, 0x05, 0x00, 0x13, 0x05, 0x04, 0x00,
    ...
    0x93, 0x08, 0x00, 0x04, 0x73, 0x00, 0x00, 0x00, 0x6f, 0xf0, 0x1f, 0xf3,
];
